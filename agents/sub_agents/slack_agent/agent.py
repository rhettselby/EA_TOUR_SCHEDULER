...
slack_agent_fallback = Agent(
    ...
    name='slack_agent_fallback',
    description= """Fallback model for when slack_agent fails to run, sends slack tour message and updates the specified tour's status in 
    the django database""",
